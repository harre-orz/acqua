...
BOOST_AUTO_TEST_SUITE(unique_container_iterator)

BOOST_AUTO_TEST_CASE(unique_container_iterator_mutable)
{
...
BOOST_AUTO_TEST_CASE(unique_container_iterator_constant)
{
