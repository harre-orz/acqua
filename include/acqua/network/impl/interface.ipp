...
inline interface::interface(internal_value_type * ifa)
    : ifa_(ifa)
{
}
...
inline internet4_address interface::to_netmask_v4() const
{
    return is_v4()
...
inline internet4_address interface::to_broadcast_v4() const
{
...
inline internet4_address interface::to_point_to_point_v4() const
{
...
inline internet6_address interface::to_address_v6() const
{
    return is_v6()
...
inline internet6_address interface::to_netmask_v6() const
{
    return is_v6()
...
inline internet6_address interface::to_broadcast_v6() const
{
...
inline internet6_address interface::to_point_to_point_v6() const
{
...
inline int interface::scope_id() const
{
    return is_v6()
...
inline int interface::index() const
{
...
inline linklayer_address interface::physical_address(boost::system::error_code & ec) const
{
...
inline void interface::physical_address(linklayer_address const & lladdr, boost::system::error_code & ec) const
{
    detail::ifreq_opts opts(ifa_->ifa_name);
...
inline int interface::mtu(boost::system::error_code & ec) const
{
    detail::ifreq_opts opts(ifa_->ifa_name);
...
inline void interface::mtu(int num, boost::system::error_code & ec) const
{
    detail::ifreq_opts opts(ifa_->ifa_name);
    opts.set_mtu(num, ec);
}

inline auto interface::begin() -> iterator
{
...
inline auto interface::end() -> iterator
{
    return iterator();
}
...
inline interface::iterator::iterator(internal_value_type * ifa)
    : base_(ifa, [](internal_value_type * ifa) { ::freeifaddrs(ifa); })
    , value_(ifa)
{
}

inline interface::iterator::iterator()
    : base_(nullptr)
    , value_(nullptr)
{
}

inline interface::iterator::iterator(iterator const & rhs)
    : base_(rhs.base_)
    , value_(rhs.value_.ifa_)
{
}

inline interface::iterator::iterator(iterator && rhs)
    : base_(std::move(rhs.base_))
    , value_(rhs.value_.ifa_)
{
}

inline interface::iterator & interface::iterator::operator=(iterator const & rhs)
{
    base_ = rhs.base_;
...
inline interface::iterator & interface::iterator::operator=(iterator && rhs)
{
    base_ = std::move(rhs.base_);
    value_.ifa_ = rhs.value_.ifa_;
    return *this;
...
inline interface const & interface::iterator::operator*() const
{
    return value_;
}
...
inline interface::iterator & interface::iterator::operator++()
{
    value_.ifa_ = value_.ifa_->ifa_next;
    return *this;
}

inline interface::iterator interface::iterator::operator++(int)
{
    iterator it(*this);
    operator++();
    return it;
...
inline bool operator==(interface::iterator const & lhs, interface::iterator const & rhs)
{
